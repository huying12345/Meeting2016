...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = 'assets/libs/pdf.js/build/images/';
  PDFJS.workerSrc = 'assets/libs/pdf.js/build/pdf.worker.js';
  PDFJS.cMapUrl = 'assets/libs/pdf.js/build/cmaps/';
