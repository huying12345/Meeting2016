...
//     如果想修改此文件的方法，请在此文件的上级目录中的DocCatalogController重写(override)该方法。
...
namespace Yamon.Module.Doc.WebApi
{
    ...
    /// 公文类型
    /// </summary>
    public partial class _DocCatalogController :BaseController
    {

        public DocCatalogDAL dal = new DocCatalogDAL();
        ...
        [NonAction]        
        public  virtual List<DocCatalog> GetGridList(string filterId, int showValue, out int totalRows)
        {
            totalRows = 0;
            ...
            List<DocCatalog> modelList = new List<DocCatalog>();
            switch(filterId)
            {
		...
		public  virtual ActionResult TreeGridByFilterID(string filterId)
        {
            ...
            try
            {
               ...
               List<DocCatalog> newModelList = modelList.Select(model => dal.GetModelGridShowValue(model)).ToList();
        ...
        public  virtual ActionResult TreeJsonByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                string fields="CatalogID,CatalogName,ParentID,OrderID";
                ...
                TreeHelper treeHelper = new TreeHelper("CatalogID", "CatalogName", "OrderID", "ParentID");
        ...
        public  virtual ActionResult AsyncTreeJsonByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                switch(filterId)
                {
                     ...
                     default:
                     {
                        table = dal.GetAsyncTreeList(parentId,"CatalogID,CatalogName");
                        break;
                     }
                }
                TreeHelper treeHelper = new TreeHelper("CatalogID", "CatalogName", "OrderID", "ParentID");
        ...
        {
            int result = dal.UpdateSingleFieldValue("CatalogName", value,id );
            hash["success"] = result > 0;
            return Json(hash);
        }   
    [LogFilter]
    ...
    public virtual ActionResult Delete(string id)
    {
        ...
        [CheckPurview(pageCode:"Doc_DocCatalog_Show")]        
