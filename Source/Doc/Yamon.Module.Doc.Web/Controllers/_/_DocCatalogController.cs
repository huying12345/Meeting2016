...
namespace Yamon.Module.Doc.Web.Controllers
{
    ...
    public partial class _DocCatalogController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            string formPath = string.Format("~/Areas/Doc/Views/DocCatalog/_/{0}.cshtml", m);
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Doc/Views/DocCatalog/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    DocCatalog model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Doc/Views/DocCatalog/_/Show.cshtml");
    return View(formPath,model);
}
