...
namespace Yamon.Module.Doc.Web.Controllers
{
    ...
    public partial class _DocInformationViewController :BaseController
    {
        ...
        {
            DocInformationView model = dal.GetCreateFormDefaultValue();
...
public virtual ActionResult Create(string id = "")
{
    ...
    string formPath = SiteCommon.GetCustomPage("~/Areas/Doc/Views/DocInformationView/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Doc/Views/DocInformationView/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    DocInformationView model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Doc/Views/DocInformationView/_/Show.cshtml");
    return View(formPath,model);
}
