    ...
    $.fn.batchFileUpload = function (options) {
        ...
        function initDropzone(containerId) {
            ...
            myDropzone = new Dropzone(document.querySelector("#" + containerId), {
                url: '/api/SiteManage/UploadFile/Upload?FieldName=' + options.FieldName + '&UploadFieldName=Upload_' + options.UploadFieldName + '&ModelID=' + options.ModelID + '&ModuleID=' + options.ModuleID,
                thumbnailWidth: 80,
                thumbnailHeight: 80,
                parallelUploads: 20,
